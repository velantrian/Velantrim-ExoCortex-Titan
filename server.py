...
from api.schemas import (
    ...
    ConsoleNoteEditRequest,
    ConsoleNoteUpdateRequest,
    CrossDomainPlanRequest,
    EpisodeRequest,
    EtirActivateBody,
    FactCreate,
    FactInboxCreateRequest,
    FactInboxPromoteRequest,
    FactInboxStatusRequest,
    FactResponse,
    GoalCreate,
    GoalStatusUpdate,
    ImmutableSnapshotBody,
    IngestRequest,
    InvalidateRequest,
    LlmTestRequest,
    QueryRequest,
    QueryResponse,
    QueryRolesRequest,
    ReasoningTraceCreateRequest,
    RouterRouteRequest,
    SourceRegisterRequest,
    TelegramIngestRequest,
    TransitionRequest,
    UmweltPerceptionCreate,
    UmweltSeedRequest,
    VolitionBody,
)
...
async def query_with_roles(req: QueryRolesRequest):
    """
