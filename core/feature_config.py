...
class AppSettings:
    ...
    # PR-ARM-03 (issue #92) — read-only, shadow-mode selective-memory
    # candidate extractor (core.selective_memory_candidates). Gates only
    # run_shadow_extraction()'s diagnostic entry point; extract_memory_
    # candidates() itself is unconditional and never writes anything.
    # Default off preserves current behavior unconditionally.
