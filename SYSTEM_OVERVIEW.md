# 🔱 Velantrim ExoCortex Titan 9.0 — Как это работает

> **Версия:** 9.0.0 · **Дата документа:** 3 июня 2026 (архитектурное описание ниже не менялось с релиза V8.7)
> **Модули `core/` и тесты:** полный pytest-набор проходит в CI · **Инвариантов:** 18 исполняемых
>
> Этот документ объясняет систему простым языком — что для чего, как работает, что с чем связано.
>
> **Ключевое (унаследовано из V8.7):** иммунная система (MetaSupervisor + ImmutableCore + ProvenanceChain),
...
>
> Titan 9.0 основан на функциональном runtime V8.7; релиз 9.0 унифицирует публичное имя и версию.
> **V8.6 (исходный код):** нетронут в отдельной папке.
