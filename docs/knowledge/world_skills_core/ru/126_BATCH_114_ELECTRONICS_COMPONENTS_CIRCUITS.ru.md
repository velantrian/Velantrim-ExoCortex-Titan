...
| ecomp.transistor.bjt_mosfet | БЮТ и МОП-транзистор | variant | биполярный (ток) vs полевой (напряжение) | выбор по задаче |
...
| ecomp.bus.uart | УАРТ | variant | последовательный обмен двумя проводами | связь МК |
| ecomp.bus.i2c | I²C | variant | шина с адресами, два провода | датчики, дисплеи |
| ecomp.bus.spi | СПИ | variant | быстрый последовательный обмен | память, дисплеи |
