...
| foodservice.kitchen.mise_en_place | Mise en place | invariant | подготовка всех ингредиентов до начала готовки | скорость и порядок на кухне |
...
| foodservice.service.foh_boh | Front of house / Back of house | invariant | зал (сервис) vs кухня (производство) | координация ресторана |
