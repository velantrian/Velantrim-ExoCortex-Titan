...
>
> ⚠️ Этот документ — **спецификация**, а не описание текущего V8.6. Раздел §7 фиксирует,
> где V8.6 сегодня **отступает** от канона (gap-анализ из глубокого аудита 2026-05-31).
...
# ✅ ЧАСТЬ V — Соответствие (conformance): чек-лист для кода
...
> Gap-анализ полностью: см. глубокий аудит 2026-05-31 (находки C1/C2/H1–H3, M1–M2, security) и
> `docs/AUDIT_V8_6.ru.md`. Каждый ❌ выше — конкретная задача миграции V8.6 к канону.
