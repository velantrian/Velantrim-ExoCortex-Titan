...
It exists to reduce blind repository-wide scanning. It is a map, not a substitute
for inspecting current code, tests, workflows, configuration, and runtime evidence.
...
> implemented code from runtime-wired, enabled, and operationally observed behavior.
...
production posture, or a known risk must update the relevant files in this directory.
